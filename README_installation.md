...
<br> If you add NFS, add it from here not from the magisk store. You will break updates if you do. Some people report NFS helps them, some people have had problems from installing NFS. I recommend trying without it, and if you seem to have stability issues from low memory, then give it a shot.
